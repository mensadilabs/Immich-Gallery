...
class MockAssetService: AssetService {
    ...
    override func fetchAssets(page: Int = 1, limit: Int? = 50, albumId: String? = nil, personId: String? = nil, tagId: String? = nil, isAllPhotos: Bool = false, isFavorite: Bool = false) async throws -> SearchResult {
